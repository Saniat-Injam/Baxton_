...
//     try {
//       EasyLoading.show(status: "Wachtwoord instellen...");
...
//         EasyLoading.dismiss();
//         EasyLoading.showSuccess("Wachtwoord gewijzigd");
//         Get.offAll(() => WorkerLoginScreen()); // ✅ Navigate to login
//       } else {
//         EasyLoading.dismiss();
...
//     } catch (e) {
//       EasyLoading.dismiss();
//       EasyLoading.showError("Er is iets misgegaan.");
//     }
//   }
...
class WorkerChangePasswordController extends GetxController {
  final newPasswordEditingController = TextEditingController();
  final confirmPasswordEditingController = TextEditingController();
    ...
    try {
      ...
      if (response.statusCode == 200 || response.statusCode == 201) {
        ...
        if (responseData['success'] == true) {
          ...
          Get.offAll(() => WorkerLoginScreen()); // Adjust to your login route
        } else {
