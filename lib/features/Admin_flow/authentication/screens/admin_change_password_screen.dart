...
import 'package:baxton/features/Admin_flow/authentication/controller/admin_change_password_controller.dart';
...
class AdminChangePasswordScreen extends StatelessWidget {
  final String? email;
  final String? code;
  const AdminChangePasswordScreen({super.key, this.email, this.code});

  @override
  Widget build(BuildContext context) {
    final AdminChangePasswordController controller = Get.put(
